...
import logo from "../assets/robot_logo.jpg"
    ...
    return (
        <>
            <aside className="h-screan">
                <nav className="h-full flex flex-col bg-white border-2 border-white rounded-lg">
                    <div className="p-4 pb-2 flex justify-between items-center">
                        <img src={logo} className={`overflow-hidden transition-all ${expanded ? "w-[100px] h-25" : "w-0"}`} />
